...
.SYNOPSIS
  ...
  SERVER 2012 ONLY
  ***THIS SCRIPT REQUIRES THE "DFSR" POWERSHELL MODULE v1.1.1 from the Microsoft ScriptCenter***
...
.OUTPUTS
  ...
  C:CGI\SCRIPTS\WINTELBAU\DFSR-BACKLOG\reports\<servername>-Folder-Backlog-Report.txt
  C:CGI\SCRIPTS\WINTELBAU\DFSR-BACKLOG\reports\<servername>-TOTAL-Backlog-Report.txt

.NOTES
  Version :        1.0
  Author :         Leon Evans
  Creation Date :  19/01/2017
  Location : https://gallery.technet.microsoft.com/scriptcenter/DFSR-Backlog-Automated-9de92f73?redir=0
...
$connection1 = Get-DfsrFolderMembership | Where-Object { $_.ComputerName -eq "$S1" } | Sort-Object -Property Folder
$connection2 = Get-DfsrFolderMembership | Where-Object { $_.ComputerName -eq "$S2" } | Sort-Object -Property Folder
